...
1.3.2. Cross-cutting concerns (logging, metrics, authentication) **SHOULD** be implemented via middleware, decorators, or interceptors—not scattered through business logic.
