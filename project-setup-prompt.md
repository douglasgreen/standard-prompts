...
* Setup steps, linting/formatting/fixing/unit testing config files, and project documentation

Basically we need complete steps to set up different kinds of [programming language] project shells.

## Standards

**INSERT PROGRAMMING LANGUAGE AND PROJECT DOCUMENTATION STANDARDS HERE.**
