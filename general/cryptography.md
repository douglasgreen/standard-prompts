...
line-length = 100
lint.select = [
  "E", "F", "I",    # correctness and imports
  "B",              # bugbear
  "UP",             # pyupgrade
  "S",              # bandit security rules
]
lint.ignore = ["S101"]  # allow asserts in tests only
lint.per-file-ignores = { "tests/**" = ["S"] }
...
# Use cryptography types
```

**Node.js/TypeScript (`.eslintrc.json`):**
