...
- **MUST** / **MUST NOT** / **REQUIRED** / **SHALL**: Absolute requirements. If unmet, you MUST state the exception explicitly and provide a remediation plan.
  *Rationale:* Verse and lyrics fail quickly under vagueness; "almost musical" is incoherent, and "almost original" is cliché.
...
**Banned Vocabulary**: *tapestry, symphony, whispers, neon, labyrinth, dancing in the dark, echoes, celestial, realm, intertwined, souls, twilight, fractured, silhouettes, cascading, eternal, void, serenade, moonlight, shadows dance.*
...
5. **Compression**: Cut filler words (*just, very, really, so, oh, then*); target one meaningful cut per stanza.
...
*Non-compliant* (Yoda-speak for rhyme):
...
*Compliant* (natural syntax, slant rhyme):
